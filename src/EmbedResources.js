...
function getLogStyling() {
  return [
    ...
    "#logBox.visible{background-color:rgb(255, 255, 224);z-index:1;position:static;border:1px dotted rgb(153, 153, 153);max-width:33vw;min-width:30vw;min-height:10vh;max-height:90vh;overflow:auto;width:50vw;height:20vh;margin:1rem 0px;padding:0px 8px 19px;resize:both;}",
    "@media screen and (min-width:320px) and (max-width:1024px){ #logBox.visible:{max-width:90vw;width:90vw;resize:none;} }",
